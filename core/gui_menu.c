 ...
 int rec=((mode_get()&MODE_MASK) == MODE_REC);
  ...
  if((conf.camera_orientation==1)||(conf.camera_orientation==3))        
    ...
    {                                                         
      ...
      draw_big_string_centre_len(title.x,8,((conf.camera_orientation==1)||(conf.camera_orientation==3))?10*BIG_FONT_WIDTH:15*BIG_FONT_WIDTH,buf,MAKE_COLOR((rec)?COLOR_BLUE:COLOR_BLUE_P,(rec)?COLOR_WHITE:COLOR_WHITE_P));      
    }
     }
...
// ERR99 fix http://chdk.setepontos.com/index.php/topic,4647.msg46080.html#msg46080
                #if defined (CAMERA_g11)|| defined (CAMERA_s90)|| defined (CAMERA_s95)|| defined (CAMERA_s100)
