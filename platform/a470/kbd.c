...
#define SWITCH_MASK2 (0x0000e000) // playback bits processed separately
...
platform_kbd_hook();
	...
	physw_status[2] = (kbd_new_state[2] & (~KEYS_MASK2)) |
      ...
      if (switch_override == 1) 
        ...
        {
          physw_status[0] = physw_status[0] & 0xff000f00;
          physw_status[1] = physw_status[1] & 0xfffff100;
          physw_status[2] = (physw_status[2] & 0x1000) | 0xc000;
        }
...
static SwitchMap switchmap[] = 
 {
        ...
        { 1, PLAYBACK_MODE, 0x00000000, 0x30000000, 0x00006000 }, 
	  { 0, 0, 0, 0, 0 }
 };
