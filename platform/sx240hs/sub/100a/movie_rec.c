...
/*************************************************************/
//** movie_record_task @ 0xFF1B82C0 - 0xFF1B8438, length=95
...
/*************************************************************/
//** sub_FF1B7840_my @ 0xFF1B7840 - 0xFF1B7B78, length=207
void __attribute__((naked,noinline)) sub_FF1B7840_my() {
asm volatile (
"    STMFD   SP!, {R0-R10,LR} \n"
"    LDR     R6, =0xAB38 \n"
"    MOV     R0, #0 \n"
...
/*************************************************************/
//** sub_FF34D754_my @ 0xFF34D754 - 0xFF34DCC8, length=350
void __attribute__((naked,noinline)) sub_FF34D754_my() {
asm volatile (
"    STMFD   SP!, {R0-R11,LR} \n"
"    MOV     R8, R0 \n"
"    LDR     R0, [R3, #0x10] \n"
