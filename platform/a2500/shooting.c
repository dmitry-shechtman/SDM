...
const CapturemodeMap modemap[] = {
    ...
    { MODE_SCN_PORTRAIT,        32787 },
    { MODE_SCN_SNOW,            32795 },
    { MODE_SCN_FIREWORK,        32797 },
    { MODE_SCN_LOWLIGHT,        32807 },
    { MODE_SCN_SUPER_VIVID,     33324 },
    { MODE_SCN_POSTER_EFFECT,   33325 },
...
void get_target_dir_name(char *out) {
    ...
    _GetImageFolder(out,get_file_next_counter(),0x80,time(NULL));
}
