...
"               LDR     R1, [R0,#0x18] \n"
"               LDR     R0, [R0,#4] \n"
"               BL      sub_FFAE80F4 \n"		// differences in firmware versions 1.00c/1.01a/1.01c
"               B       loc_FF985FB8 \n"
"loc_FF985F7C: \n"
...
"       BL      sub_FFAE6A58_my \n"     // IXUS220 Firmware 1.01c = sub_FFAE6A58; Firmware 1.00c/1.01a = sub_FFAE6A44; patched 
...
"       CMP     R0, #0 \n"
"       LDREQ   R1, =0x32A \n"
"       LDREQ   R0, =0xFFAE5A34 \n"     // IXUS220 1.01c at 0xFFAE5A34 aMovwriter_c ; "MovWriter.c"
"       MOV     R5, #0 \n"
"       MOV     R4, R2 \n"
"       MOV     R10, R3 \n"
"       MOV     R7, R5 \n"
