...
"loc_FF87CEC8:\n"
               ...
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CDA4 entry 4
"loc_FF87CEE0:\n"
               "BL     sub_FF87D358\n"
               "B      loc_FF87CEC0\n"

// ---------------------------------------------------------------------------
// jumptable FF87CDA0 entry 3
"loc_FF87CEE8:\n"
               "BL     sub_FF87D688\n"
               "B      loc_FF87CEC0\n"
// ---------------------------------------------------------------------------
// jumptable FF87CDA8 entry 5
"loc_FF87CEF0:\n"
               "BL     sub_FF87D690\n"
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CDAC entry 6
"loc_FF87CEF8:\n"
               "BL     sub_FF87D848\n"
               "B      loc_FF87CF5C\n"
// ---------------------------------------------------------------------------
// jumptable FF87CDB0 entry 7
"loc_FF87CF00:\n"
               "LDR    R5, [R0,#0xC]\n"
               "BL     sub_FF87D698\n"
               "MOV    R0, R5\n"
...
"loc_FF87CF5C:\n"
               ...
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CDBC entry 10
"loc_FF87CF64:\n"
               "LDR    R0, [R4,#0x54]\n"
               "BL     sub_FF87DF5C\n"
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CDC0 entry 11
"loc_FF87CF70:\n"
               "BL     sub_FF87E204\n"
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CDC4 entry 12
"loc_FF87CF78:\n"
               "BL     sub_FF87E294\n"
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CDB8 entry 9
"loc_FF87CF80:\n"
               "BL     sub_FF87D688\n"
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CDC8 entry 13
"loc_FF87CF88:\n"
               "BL     sub_FF960D64\n"
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CDCC entry 14
"loc_FF87CF90:\n"
               "BL     sub_FF960FBC\n"
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CDD0 entry 15
"loc_FF87CF98:\n"
               "BL     sub_FF96105C\n"
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CDD4 entry 16
"loc_FF87CFA0:\n"
               "BL     sub_FF961190\n"
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CDD8 entry 17
"loc_FF87CFA8:\n"
               "BL     sub_FF961260\n"
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CDDC entry 18
"loc_FF87CFB0:\n"
               "MOV    R0, #0\n"
               "B      loc_FF87CFD4\n"
// ---------------------------------------------------------------------------
// jumptable FF87CDE0 entry 19
"loc_FF87CFB8:\n"
               "BL     sub_FF961838\n"
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CDE4 entry 20
"loc_FF87CFC0:\n"
               "BL     sub_FF9618C8\n"
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CDE8 entry 21
"loc_FF87CFC8:\n"
               "BL     sub_FF961988\n"
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CDEC entry 22
"loc_FF87CFD0:\n"
               "MOV    R0, #1\n"
"loc_FF87CFD4:\n"
               "BL     sub_FF9616F8\n"
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CDF0 entry 23
"loc_FF87CFDC:\n"
               "BL     sub_FF87DB74\n"
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CDF4 entry 24
"loc_FF87CFE4:\n"
               "BL     sub_FF87DC14\n"
               "BL     sub_FF87D1B8\n"
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CDF8 entry 25
"loc_FF87CFF0:\n"
               "BL     sub_FF961520\n"
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CDFC entry 26
"loc_FF87CFF8:\n"
               "MOV    R2, #2\n"
               "ADD    R1, R4, #0x6A\n"
               "MOV    R0, #0x6F\n"
               ...
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CE00 entry 27
"loc_FF87D028:\n"
               "BL     sub_FF96164C\n"
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CE04 entry 28
"loc_FF87D030:\n"
               "BL     sub_FF87C4A8\n"
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CE08 entry 29
"loc_FF87D038:\n"
               "BL     sub_FF835E64\n"
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CE0C entry 30
"loc_FF87D040:\n"
               "BL     sub_FF880584\n"
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CE10 entry 31
"loc_FF87D048:\n"
               "BL     sub_FF8805EC\n"
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CE14 entry 32
"loc_FF87D050:\n"
               "BL     sub_FF880648\n"
               "BL     sub_FF880608\n"
               "B      loc_FF87D090\n"
// ---------------------------------------------------------------------------
// jumptable FF87CE18 entry 33
"loc_FF87D05C:\n"
               "MOV    R0, #1\n"
               "BL     sub_FF962EE8\n"
               "MOV    R0, #1\n"
