...
if (p[0]==0xFF961780)  p[0]=(int)movie_record_task;
if (p[0]==0xFF898314)  p[0]=(int)init_file_modules_task;
}
...
long* led_AF = (long*) 0xC0223030; // AF
long* led1 = (long*) 0xc02200d4;
#define on_af()  *led_AF = 0x46

#define on()  *led1 = 0x46
#define off() *led1 = 0x44
long start_1 = 0;
long start_2 = 0;
long start_3 = 0;
...
void __attribute__((naked,noinline)) sub_FF810354_my() {
    ...
    *(int*)0x1938=(int)taskCreateHook; 		
	...
	start_1 = (*(int*)0xC0220128);
	start_2 = (*(int*)0xC022012C);
	start_3 = *(int*)(0x254C);
...
void __attribute__((naked,noinline)) sub_FF88D35C_my() { 
 asm volatile (
        "STMFD   SP!, {R4,LR}\n"
        "MOV     R0, #3\n"
        //"BL      sub_FF86DFAC\n"
