...
"loc_FF9617F0:\n" //  ; jumptable FF9617C0 entry 9
        ...
        "STR     R5, [R4,#0x38]\n"
        "B       loc_FF961864\n"
"loc_FF961818:\n" // ; jumptable FF9617C0 entry 0
		"BL      unlock_optical_zoom\n" //+-----> inserted to unlock the zoom
        "BL      sub_FF9615A0\n"
        "B       loc_FF961864\n"
"loc_FF961820:\n" // ; jumptable FF9617C0 entry 4
        //"BL      sub_FF961118\n"
		"BL      sub_FF961118_my\n" // +----------------->
        "B       loc_FF961864\n"
"loc_FF961828:\n" // ; jumptable FF9617C0 entry 6
        "LDR     R1, [R0,#0x18]\n"
        "LDR     R0, [R0,#4]\n"
        "BL      sub_FFA96E98    \n"
        "B       loc_FF961864\n"
"loc_FF961838:\n" //; jumptable FF9617C0 entry 1
        "LDR     R0, [R4,#0x38]\n"
        "CMP     R0, #5\n"
        "STRNE   R5, [R4,#0x28]\n"
        "B       loc_FF961864\n"
...
void __attribute__((naked,noinline)) sub_FF961118_my(){ 
 asm volatile(
        "STMFD   SP!, {R4-R8,LR}\n"
        "SUB     SP, SP, #0x40\n"
        "MOV     R7, #0\n"
