...
const ShutterSpeed shutter_speeds_table[] = {
    ...
    {  30,  960, "1/1000", 1000 },
    {  31,  992, "1/1250",  800 },
    {  32, 1021, "1/1600",  667 }, // ROM:FF9B5A9C 0x3FD (word) = 1021 cs 662
};
...
//    { MODE_M,                  32772 },
    ...
    { MODE_SCN_KIDS_PETS,      16400 }, //  { MODE_SCN_KIDS_PETS,          16400 },
    { MODE_SCN_INDOOR,         16401 }, //  { MODE_SCN_INDOOR,          16401 },
    { MODE_SCN_FOLIAGE,        16402 }, //  { MODE_SCN_FOLIAGE,          16402 },
    { MODE_SCN_SNOW,           16403 },
