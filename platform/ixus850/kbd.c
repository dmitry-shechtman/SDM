...
#define SWITCH_MASK0 (0x00000000)// playback bits processed separately
...
static SwitchMap switchmap[] = 
 {
        { 1, MOVIE_MODE, 0x00000000, 0x00000000, 0x00005000 },
        { 1, PLAYBACK_MODE, 0x00000000, 0x00000000, 0x00003000 }, 
	  { 0, 0, 0, 0, 0 }
 };
