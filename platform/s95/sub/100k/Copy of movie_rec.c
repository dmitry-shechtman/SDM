...
{
// int x1 = *((volatile int *)0xC0F07008) & 0xffff;					// read counter
// draw_line(x1,0,x1,240,MAKE_COLOR(0x2b,0x2b));
	      gFramesRecorded++;
...
int x1 = *((volatile int *)0xC0F07008) & 0xffff;
draw_pixel(x1,120,0x2b);

/*
 int x1 = *((volatile int *)0xC0F07008) & 0xffff;					// read counter
 draw_line(x1,0,x1,240,MAKE_COLOR(0x66,0x66));
*/
...
void __attribute__((naked,noinline)) movie_record_task()
{
	asm volatile (
"	STMFD	SP!, {R2-R8,LR} \n"    
// "	BL	     period \n"			// once only after camera turned on and recording started.           
"	LDR	R8, =0x2710 \n"                      
"	LDR	R4, =0x7128 \n"                      
"	MOV	R7, #1 \n"                           
"	LDR	R6, =0xFF98611C \n"                  
