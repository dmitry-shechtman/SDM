...
/*---------------------------------------------------------------------
  Memory Map:
	...
	0010FE3                             end of inited data
	0010FE4                             start of bss - used for zeroed/uninited vars
	0016E2F                             end of bss
	016EE30     MEMISOSTART             start of our data / bss

	0400000                             raw buffers (bigger than s90 due to HDR ??)
