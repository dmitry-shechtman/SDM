...
/*************************************************************/
//** taskcreate_Startup_my @ 0xFF81C1A8 - 0xFF81C228, length=33
...
"loc_FF81C1EC:\n"
//"  BL      _sub_FF84A8D0 \n"  // removed for corrected power-on/off
//"  BL      _sub_FF84A8CC \n"  // --> Nullsub call removed.
"    BL      sub_FF8282FC \n"
"    LDR     R1, =0x3CE000 \n"
"    MOV     R0, #0 \n"
...
/*************************************************************/
//** CreateTask_PhySw @ 0xFF8218CC - 0xFF82191C, length=21
...
"    MOV     R3, #0 \n"
"    STR     R3, [SP] \n"
"    LDR     R3, =mykbd_task \n"  // --> Patched. Old value = 0xFF821898.
"    MOV     R2, #0x2000 \n"  // --> Patched. Old value = 0x800. stack size for new task_PhySw
"    MOV     R1, #0x17 \n"
"    LDR     R0, =0xFF821AD4 /*'PhySw'*/ \n"
"    BL      sub_FF828544 /*_CreateTaskStrictly*/ \n"
"    STR     R0, [R4, #0x10] \n"

"loc_FF821900:\n"
"    BL      sub_FF84B338 \n"
"    BL      sub_FF8249CC \n"
"    BL      sub_FF8230A4 /*_IsFactoryMode_FW*/ \n"
"    CMP     R0, #0 \n"
"    LDREQ   R1, =0x11CC4 \n"
"    LDMEQFD SP!, {R3-R5,LR} \n"
"    BEQ     sub_FF875BFC /*_OpLog.Start_FW*/ \n"
"    LDMFD   SP!, {R3-R5,PC} \n"
);
}
...
/*************************************************************/
//** init_file_modules_task @ 0xFF882EA8 - 0xFF882EDC, length=14
...
/*************************************************************/
//** sub_FF878098_my @ 0xFF878098 - 0xFF8780D4, length=16
void __attribute__((naked,noinline)) sub_FF878098_my() {
asm volatile (
"    STMFD   SP!, {R4,LR} \n"
"    BL      sub_FF859C00_my \n"  // --> Patched. Old value = 0xFF859C00.
//"  BL      _sub_FF91F284 \n"  // --> Nullsub call removed.
"    LDR     R4, =0x585C \n"
"    LDR     R0, [R4, #4] \n"
"    CMP     R0, #0 \n"
...
/*************************************************************/
//** sub_FF859C00_my @ 0xFF859C00 - 0xFF859C98, length=39
...
/*************************************************************/
//** sub_FF859A3C_my @ 0xFF859A3C - 0xFF859AA4, length=27
...
/*************************************************************/
//** sub_FF8597CC_my @ 0xFF8597CC - 0xFF859930, length=90
...
/*************************************************************/
//** JogDial_task_my @ 0xFF84B23C - 0xFF84B334, length=63
...
"    LDR     R3, =0x1AE \n"
"    LDR     R0, [R6, #0xC] \n"
"    LDR     R2, =0xFF84B494 /*'JogDial.c'*/ \n"
"    MOV     R1, #0 \n"
"    BL      sub_FF82862C /*_TakeSemaphoreStrictly*/ \n"
"    MOV     R0, #0x28 \n"
"    BL      _SleepTask \n"
//------------------  added code ---------------------
"sleep_loop:\n"
