...
p-=17;
if (p[0]==0xFF87B18C)  p[0]=(int)capt_seq_task;
if (p[0]==0xFF962CB0)  p[0]=(int)movie_record_task;
if (p[0]==0xFF898FD8)  p[0]=(int)init_file_modules_task; 
}
...
void __attribute__((naked,noinline)) sub_FF88DFCC_my() { 
 asm volatile (
               "STMFD   SP!, {R4,LR}\n"
               "MOV     R0, #3\n"
               //"BL      sub_FF86F8AC\n"
...
"loc_FF86F224:\n"
               "B       loc_FF86F228\n"
"loc_FF86F228:\n"
// jumptable FF8"F200 entries 1-4,6,7
               "MOV     R2, #0\n"
               "MOV     R1, #0x200\n"
               "MOV     R0, #2\n"
               "BL      sub_FF887FDC\n"
...
"loc_FF86F304:\n"
               ...
               "B       loc_FF86F340\n"
"loc_FF86F32C:\n"
//; jumptable FF8"F200 entry 5
               "MOV     R6, #0x40\n"
               "B       loc_FF86F340\n"
"loc_FF86F334:\n"
//; jumptable FF8"F200 default entry
               "LDR     R1, =0x568\n"
               "LDR     R0, =0xFF86F378\n"
               "BL      sub_FF81E88C\n"
"loc_FF86F340:\n"
