...
#define SWITCH_MASK0 (0x00000008)
#define SWITCH_MASK1 (0x0c000000) // playback bits processed separately
#define SWITCH_MASK2 (0x00007000) // playback bits processed separately
...
platform_kbd_hook();
	...
	physw_status[2] = (kbd_new_state[2] & (~KEYS_MASK2)) |
      ...
      if (switch_override == 1) 
        ...
        {
          physw_status[1] = ((physw_status[1] & (~SWITCH_MASK1)) | (switch_mod_state[1] & SWITCH_MASK1))& 0xfdfffffb;
        }
      }
...
static SwitchMap switchmap[] = 
 {
        { 1, MOVIE_MODE, 0x00000008, 0x04000000, 0x00005000 },
