...
void __attribute__((naked,noinline)) sub_FF879FA4_my() { // sub_FF87A044_my (102b)
 asm volatile(
                 "STMFD   SP!, {R4,LR}\n"
                 "BL      sub_FF85AB08_my\n"    //----------->
           //    "BL      nullsub_66\n"
