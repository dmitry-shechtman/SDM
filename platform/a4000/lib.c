...
// 256 entry palette based on a4000.100c
// sub_FF90ACB8  <- Called for a function with 1 ref to **"Palette Class. (sub_ffab8ef0)
int vid_get_palette_type()                      { return 3; }
int vid_get_palette_size()                      { return 256 * 4; }

void *vid_get_bitmap_active_buffer()
{   //found @loc_ff90ad5c a4000.100c ->Called before *"..<GetBmpVramInfo> Add
    return (void*)(*(int*)(0x5470+0x18));
}
