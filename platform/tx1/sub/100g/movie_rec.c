...
void __attribute__((naked,noinline)) movie_record_task(){   //task_MovieRecord 0xFFBAD2F0
 asm volatile(
                "STMFD   SP!, {R4,R5,LR}\n"
                "SUB     SP, SP, #4\n"
                "MOV     R5, SP\n"
...
void __attribute__((naked,noinline)) sub_FFBADAE4_my(){
 asm volatile(
                "STMFD   SP!, {R4-R11,LR}\n"
                "LDR     R5, =0xB3F68\n"
                "SUB     SP, SP, #0x3C\n"
...
void __attribute__((naked,noinline)) sub_FFB1CF10_my(){
 asm volatile(
