...
static long *nrflag = (long*)(0x88a4+0x00);  // Found @ ff9e4ea0 & ff9e4ee8
...
//** sub_FF9651F8_my  @ 0xFF9651F8

void __attribute__((naked,noinline)) sub_FF9651F8_my(  ) {
asm volatile (
      "STMFD   SP!, {R4-R6,LR}\n"
      "LDR     R5, =0x36F6C\n"
      "MOV     R6, R0\n"
...
//** sub_FF8ACE94_my  @ 0xFF8ACE94 

void __attribute__((naked,noinline)) sub_FF8ACE94_my(  ) {
asm volatile (
      "STMFD   SP!, {R4-R8,LR}\n"
      "LDR     R7, =0x3DE4\n"
      "MOV     R4, R0\n"
