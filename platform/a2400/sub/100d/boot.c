...
void __attribute__((naked,noinline)) sub_FF810380_my(  ) { 
   ...
   *(int*)0x1938=(int)taskHook;
    ...
    // C02200F8  a2400.100e sub_FF81A6BC : C0220000 (@FF81A6C4) + 0xF8 (@FF81A6E8)
    // 0x24B0    a2400 100e Found @ 0xFF856494
...
//** init_file_modules_task  @ 0xFF889004 
