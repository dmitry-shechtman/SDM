...
/*
http://www.usa.canon.com/cusa/consumer/products/cameras/digital_cameras/powershot_sx150_is#Specifications
Shooting Modes:
...
// SX150IS uses date to name directory
