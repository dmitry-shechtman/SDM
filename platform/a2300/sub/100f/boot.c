...
void __attribute__((naked,noinline)) sub_FF810380_my(  ) { 
   ...
   *(int*)0x1938=(int)taskHook;
    ...
    // C02200F8  a2300 
    // 0x24b8    a2300 b101 @ 0xFF82EAFC => ff8565c4
...
//** sub_FF81A6AC_my  @ 0xFF81A6AC 

void __attribute__((naked,noinline)) sub_FF81A6AC_my(  ) { 
asm volatile (
      "STMFD   SP!, {R4,LR}\n"
      "BL      sub_FF82EAF4\n"
...
//** taskcreate_Startup_my  @ 0xFF81A6C0 
...
//** init_file_modules_task  @ 0xFF886C2C 
