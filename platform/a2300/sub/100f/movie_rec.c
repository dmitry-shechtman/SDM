...
"loc_FF95B808:\n" //Jump Table entry 05
      ...
      "BLX     R1\n"
//begin patch
      "LDR	   R0, =0x639C \n"		// added, 0x63A0-0x4 taken from  "loc_FF95B5F4" see commented function below.
      "BL      set_quality \n"		// added
//end patch
      "B       loc_FF95B850\n"
"loc_FF95B814:\n" //Jump Table entry 07
...
//This function was used to take values for set_quality
//** sub_FF95AB0D0_my  @ 0xFF95B0D0
/*
void __attribute__((naked,noinline)) sub_FF95AB0D0_my(  ) {
asm volatile (
      "STMFD   SP!, {R4-R11,LR}\n"
      "SUB     SP, SP, #0x64\n"
      "MOV     R9, #0\n"
