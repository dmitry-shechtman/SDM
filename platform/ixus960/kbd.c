...
#define SWITCH_MASK0 (0x70000000)
#define SWITCH_MASK1 (0x00000000) 
#define SWITCH_MASK2 (0x30000000) 
...
static KeyMap keymap[] = {
      { 0, KEY_PLAYBACK        ,0x40000000 },  
      { 0, KEY_POWER           ,0x80000000 },
	{ 2, KEY_UP		       ,0x00000080 }, 
...
static SwitchMap switchmap[] = 
 {
        { 1, MOVIE_MODE, 0x60000000, 0x00000000, 0x20000000 },
