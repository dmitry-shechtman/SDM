...
/*************************************************************/
//** sub_FFADA1E0_my @ 0xFFADA1E0 - 0xFFADA260, length=33
void __attribute__((naked,noinline)) sub_FFADA1E0_my() {
asm volatile (
"    STMFD   SP!, {R2-R10,LR} \n"
"    MOV     R4, R0 \n"
"    BL      sub_FFAD9DB4 \n"
...
"    TST     R0, #1 \n"
"    LDRNE   R2, =0x17B \n"
"    LDRNE   R1, =0xFFADA448 /*'SsStandardCaptureSeq.c'*/ \n"
"    MOVNE   R0, #0 \n"
"    BLNE    _DebugAssert \n"
"    LDR     R0, [SP, #4] \n"
"    AND     R0, R0, #0xFF00 \n"
