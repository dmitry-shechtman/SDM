...
{
    //return (void*)0x2F490;
	return (void*)0x2EC10; // find on "taskcreate_ImageSensorTask" 
}

void *hook_raw_ret_addr()
{
    //return (void*)0xFF8D8BDC;
	return (void*)0xFF8E0EEC; // From inside the TgTool_Delete
}
...
{
    return (void*)0x103CEB20; // (found on aBmpddev_c)
}
...
//    return (void*)0x10559670;
    return (void*)0x105F84F0; // Next function after CreateImagePhysicalVramForStitch
}
...
void *vid_get_viewport_fb_d()
{
 ...
 return (void*)(*(int*)0x6EAD0); // found on aImageplayer_c
