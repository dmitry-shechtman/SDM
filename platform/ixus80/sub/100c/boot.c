...
//static const
//const char* outfile = "A/auspuutt.log\0";
...
void __attribute__((naked,noinline)) task_Startup_my() { //#fs
	asm volatile (
		...
		"BL	sub_FF822E14 \n"	// ?
		"BL	sub_FF81FEB8 \n"	// tons of IO: c0221000+,c0400000,ClkEnabler
		"BL	sub_FF829FE4 \n"	// ff842aa4: I/O wr 0xc0223000,0xc0223024,#32
		"BL	sub_FF82A1AC \n"	// ADCScn
//	"BL	sub_FF82A06C \n"		// <StartDiskboot +54060>
	);
	// CreateTask_blinker();
	...
	asm volatile (
		"BL	sub_FF82A360 \n"	// ff873ac4: :KernelMisc:KerSem

	"BL	sub_FF82A1FC \n" 	// taskcreate_WdtReset,taskcreate_AudioTsk, Watchdog
//	"BL	sub_FF82A1FC_my \n" 	// ---> debug Watchdog
								// taskcreate_Thermometer, taskcreate_LEDCon

	"BL	sub_FF82786C \n"	// <- sets up exception handlers (!)
//	"BL	sub_FF82786C_my \n"	// ---------> debug exception handlers

		"BL	sub_FF82A364 \n"	// UiMemory,CtrlEx,StartEventExchanger__ok,CtrlMan

//	"BL	sub_FF821BC8 \n"		// <taskcreate_PhySw +20084>KernelCreateTask
	"BL	sub_FF821BC8_my \n"		// --> spawn mykbd_task
	);

//	CreateTask_PhySw; // + mh, does not startup.
	asm volatile (
//	"BL	sub_FF824D7C \n"    	// task_ShootSeqTask
	"BL	sub_FF824D7C_my \n" 	// "CreateTask_PhySw" ----------> ok
