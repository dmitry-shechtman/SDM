...
#define SWITCH_MASK0 (0x00000000) // to be determined
#define SWITCH_MASK1 (0x30000020) // and some bits separately forced to zero
...
platform_kbd_hook();
	...
	physw_status[2] = (kbd_new_state[2] & (~KEYS_MASK2)) |
      ...
      if (switch_override == 1) 
        ...
        {
          physw_status[0] = ((physw_status[0] & (~SWITCH_MASK0)) | (switch_mod_state[0] & SWITCH_MASK0)) & 0xfffeffff;
          physw_status[1] = ((physw_status[1] & (~SWITCH_MASK1)) | (switch_mod_state[1] & SWITCH_MASK1)) & 0xfff00fff;
        }
...
static SwitchMap switchmap[] = 
 {
        { 1, MOVIE_MODE, 0x00000000, 0x30000020, 0x00000000 },    // to be determined
        { 1, PLAYBACK_MODE, 0x00000000, 0x10000020, 0x00000000 }, // some bits forced to zero separately
	  { 0, 0, 0, 0, 0 }
 };
